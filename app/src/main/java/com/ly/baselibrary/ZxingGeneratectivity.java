...
public class ZxingGeneratectivity extends AppCompatActivity {
    ...
    private void createChineseQRCode() {
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected Bitmap doInBackground(Void... params) {
                return QRCodeEncoder.syncEncodeQRCode("王浩", BGAQRCodeUtil.dp2px(ZxingGeneratectivity.this, 150));
            }
            ...
            protected void onPostExecute(Bitmap bitmap) {
                if (bitmap != null) {
                    ...
                    Toast.makeText(ZxingGeneratectivity.this, "生成中文二维码失败", Toast.LENGTH_SHORT).show();
                }
            }
        }.execute();
    }
    ...
    private void createEnglishQRCode() {
        new AsyncTask<Void, Void, Bitmap>() {
            @Override
            protected Bitmap doInBackground(Void... params) {
                return QRCodeEncoder.syncEncodeQRCode("bingoogolapple", BGAQRCodeUtil.dp2px(ZxingGeneratectivity.this, 150), Color.parseColor("#ff0000"));
            }
            ...
            protected void onPostExecute(Bitmap bitmap) {
                if (bitmap != null) {
                    ...
                    Toast.makeText(ZxingGeneratectivity.this, "生成英文二维码失败", Toast.LENGTH_SHORT).show();
                }
            }
        }.execute();
    }
    ...
    private void createChineseQRCodeWithLogo() {
        new AsyncTask<Void, Void, Bitmap>() {
            @Override
            protected Bitmap doInBackground(Void... params) {
                Bitmap logoBitmap = BitmapFactory.decodeResource(ZxingGeneratectivity.this.getResources(), R.mipmap.logo);
                return QRCodeEncoder.syncEncodeQRCode("王浩", BGAQRCodeUtil.dp2px(ZxingGeneratectivity.this, 150), Color.parseColor("#ff0000"), logoBitmap);
            }
            ...
            protected void onPostExecute(Bitmap bitmap) {
                if (bitmap != null) {
                    ...
                    Toast.makeText(ZxingGeneratectivity.this, "生成带logo的中文二维码失败", Toast.LENGTH_SHORT).show();
                }
            }
        }.execute();
    }
    ...
    private void createEnglishQRCodeWithLogo() {
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected Bitmap doInBackground(Void... params) {
                Bitmap logoBitmap = BitmapFactory.decodeResource(ZxingGeneratectivity.this.getResources(), R.mipmap.logo);
                return QRCodeEncoder.syncEncodeQRCode("bingoogolapple", BGAQRCodeUtil.dp2px(ZxingGeneratectivity.this, 150), Color.BLACK, Color.WHITE,
                        logoBitmap);
            }
            ...
            protected void onPostExecute(Bitmap bitmap) {
                if (bitmap != null) {
                    ...
                    Toast.makeText(ZxingGeneratectivity.this, "生成带logo的英文二维码失败", Toast.LENGTH_SHORT).show();
                }
            }
        }.execute();
    }
    ...
    private void createBarcodeWidthContent() {
        new AsyncTask<Void, Void, Bitmap>() {
            @Override
            protected Bitmap doInBackground(Void... params) {
                int width = BGAQRCodeUtil.dp2px(ZxingGeneratectivity.this, 150);
                int height = BGAQRCodeUtil.dp2px(ZxingGeneratectivity.this, 70);
                int textSize = BGAQRCodeUtil.sp2px(ZxingGeneratectivity.this, 14);
            ...
            protected void onPostExecute(Bitmap bitmap) {
                if (bitmap != null) {
                    ...
                    Toast.makeText(ZxingGeneratectivity.this, "生成条底部带文字形码失败", Toast.LENGTH_SHORT).show();
                }
            }
        }.execute();
    }
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected void onPostExecute(Bitmap bitmap) {
                if (bitmap != null) {
                    ...
                    Toast.makeText(ZxingGeneratectivity.this, "生成条底部不带文字形码失败", Toast.LENGTH_SHORT).show();
                }
            }
        }.execute();
    }
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected void onPostExecute(String result) {
                if (TextUtils.isEmpty(result)) {
                    Toast.makeText(ZxingGeneratectivity.this, errorTip, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(ZxingGeneratectivity.this, result, Toast.LENGTH_SHORT).show();
                }
            }
        }.execute();
    }
