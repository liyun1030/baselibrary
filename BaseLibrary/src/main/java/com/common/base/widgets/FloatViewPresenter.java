...
import com.common.base.tools.WindowManagerInstance;
...
//        wmParams.type=2002;  //type是关键，这里的2002表示系统级窗口
            ...
            wmParams.width = (int) context.getResources().getDimension(R.dimen.float_width);
            wmParams.height = (int) context.getResources().getDimension(R.dimen.float_width);
            fsv = new FloatView(context);
            wmParams.x = fsv.sW/2;
            wmParams.y = fsv.sH/2;
            fsv.setOnFloatViewClickListener(this);
            fsv.setImageResource(R.mipmap.ic_launcher_round);
            try {
                //只add一次
