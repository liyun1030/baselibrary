    ...
    private class SlidingTabIndicator extends LinearLayout {
        ...
        private void updateIndicatorPosition() {
            ...
            if (selectedTitle != null && selectedTitle.getWidth() > 0) {
                ...
                if (!GlueTabLayout.this.tabIndicatorFullWidth && selectedTitle instanceof TabView) {
                    this.calculateTabViewContentBounds((TabView) selectedTitle, GlueTabLayout.this.tabViewContentBounds);
                ...
                if (this.selectionOffset > 0.0F && this.selectedPosition < this.getChildCount() - 1) {
                    ...
                    if (!GlueTabLayout.this.tabIndicatorFullWidth && nextTitle instanceof TabView) {
                        this.calculateTabViewContentBounds((TabView) nextTitle, GlueTabLayout.this.tabViewContentBounds);
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if (targetView == null) {
                ...
                if (!GlueTabLayout.this.tabIndicatorFullWidth && targetView instanceof TabView) {
                    this.calculateTabViewContentBounds((TabView) targetView, GlueTabLayout.this.tabViewContentBounds);
